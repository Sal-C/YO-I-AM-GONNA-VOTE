...
const Learn = (props) => {
  return (
    <div>
      <h1 className="text-center" style={{marginBottom: "200px", marginTop:"50px"}}>Yo I'm 'Onna Vote </h1>
      ...
      <Row>
        <Col sm="4"></Col>
        <Col sm="2">
          <p>Check if and where you are currently registered to vote. The process takes thirty seconds and will determine if you have an active voter registration anywhere in the 50 U.S. states, the District of Columbia, and Puerto Rico.</p>
        </Col>
        <Col sm="2">
      ...
      <Row>
        <Col sm="4"></Col>
        <Col sm="2">
          <p>You've determined you're registered to vote and you know when the next election will be held. All that's left is figuring out whose on the ballot. Using a current address, find out information about your elected representatives and officials at the federal, state, county, and local levels.</p>
        </Col>
        <Col sm="2">
